...
- The per-mirror copier detail the Trading page's uniform fleet cards deliberately don't carry: desired leader, multiplier, inferred P/L, room, win days, last synced.
- Grouped per firm. "(pending)" next to a leader means the plan assigns it but you have not marked the plan applied yet.
- **Last synced** shows the last balance sync (manual or observed); "never" or stale dates surface as yellow hazards.
